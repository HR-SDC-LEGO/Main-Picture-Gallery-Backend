...
--   image_id SERIAL,
--   FOREIGN KEY (product_id) REFERENCES products(product_id),
--   product_image TEXT ARRAY
-- );

-- INSERT INTO products(product_name) VALUES("Colloseium");
-- insert into products values("Colloseium", "1");

  -- insert into images (product_id, image_id, product_image)  values("1","1026", "https://legoimages.s3-us-west-1.amazonaws.com/Lego-product-pictures/10276_alt10.jpg");
  -- insert into images (product_id, image_id, product_image)  values("1","106", "https://legoimages.s3-us-west-1.amazonaws.com/Lego-product-pictures/10276_alt10.jpg");
