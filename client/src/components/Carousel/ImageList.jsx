...
class ImageList extends React.Component {
  ...
  render() {
    const { images, selectedImageIndex, startingIndexForImageCarosel, changeMainPicture, carouselUp, carouselDown } = this.props;
    // const { startingIndexForImageCarosel } = this.state;
    ...
    return (
      ...
      rangeOfRenderingCarosel.map((item, index) => {
        ...
        return (
          <ImageListItem imgContainer={item} key={imageIndex} handleChange={changeMainPicture} id={imageIndex} isSelected={selectedImageIndex === imageIndex} />
        );
      })
        }
